		...
		<div id="container" class="container-fluid">
			<div id="alert" style="${not empty message ? 'display: block;' : 'display: none;'}" class="alert alert-dismissable ${alertType eq 1 ? 'alert-success' : 'alert-danger'}">
	 	 	...
	 	 	<div id="top" class="row">
			    ...
			    <div class="col-md-3">
			        <a href="/crud-manager/post/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Serviço</a>
			            ...
			            <tbody>
			            	<c:forEach var="post" items="${posts}">
							    <tr>
							        ...
							        <td>${post.getCustomer().getName()}</td>
							        <td>
							            <a href="${pageContext.request.contextPath}/post/update?postId=${post.getId()}" class="btn btn-primary">Editar</a>
							            
							        </td>
							        <td>
							        <!--<a href="${pageContext.request.contextPath}/post/delete?id=${post.getId()}" class="btn btn-danger">Deletar</a>-->
